  ...
  if (error) {
    return (
      <Alert 
        ...
        sx={{ mt: 2 }}
        action={
          <button onClick={fetchDashboardStats} style={{ background: 'none', border: 'none', color: 'inherit', cursor: 'pointer' }}>
            Retry
          </button>
        }
      >
                ...
                <List>
                  {stats.topPerformers.map((performer, index) => (
                    <React.Fragment key={performer.id}>
                      ...
                      {index < stats.topPerformers.length - 1 && <Divider variant="inset" component="li" />}
                    </React.Fragment>
                  ))}
                </List>
              </Paper>
                ...
                <List>
                  {stats.topCustomers.map((customer, index) => (
                    <React.Fragment key={customer.name}>
                      ...
                      {index < stats.topCustomers.length - 1 && <Divider variant="inset" component="li" />}
                    </React.Fragment>
                  ))}
                </List>
              </Paper>
                  ...
                  <Grid container spacing={2}>
                    <Grid item xs={6}>
                      <Paper sx={{ p: 2, textAlign: 'center', bgcolor: '#e8f5e9' }}>
                        ...
                        <Typography variant="caption">Avg. Deal Size</Typography>
                      </Paper>
                    </Grid>
                    <Grid item xs={6}>
                      <Paper sx={{ p: 2, textAlign: 'center', bgcolor: '#fff3e0' }}>
                        ...
                        <Typography variant="caption">Deals with Budget</Typography>
                      </Paper>
                    </Grid>
                    <Grid item xs={12}>
                      <Box sx={{ mt: 2 }}>
                    ...
                    <Grid item xs={12}>
                      <Box sx={{ mt: 2 }}>
                        ...
                        <Typography variant="body2">
                          {formatINR(stats.budgetStats.minBudget)} - {formatINR(stats.budgetStats.maxBudget)}
                        </Typography>
                      </Box>
                    </Grid>
                  </Grid>
