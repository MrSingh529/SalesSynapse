...
import { Business, Login as LoginIcon, Close, Email } from '@mui/icons-material';
    ...
    <>
              ...
              >
                <img 
                  ...
                  onError={(e) => {
                    ...
                    e.target.parentElement.innerHTML = '<Business sx={{ fontSize: 40, color: "primary.main" }} />';
                  }}
                />
              </Avatar>
      ...
      >
        ...
        <DialogActions sx={{ p: 2 }}>
          ...
          {resetSuccess && (
            <Button onClick={handleResetDialogClose} variant="contained" fullWidth>
              Close
            </Button>
          )}
        </DialogActions>
